...
const Header = () => {
	return (
		<header className="z-[999] relative">
			...
			>
				<nav className="flex items-center justify-center h-12 sm:h-[initial] py-2 sm:py-0">
					<ul className="flex flex-wrap justify-center items-center w-[22rem] gap-y-1 text-[0.9rem] font-medium text-gray-500 sm:w-[initial] sm:flex-nowrap sm:gap-5">
						{links.map((link) => (
							<li
